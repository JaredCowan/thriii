    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                $("#edit-header").text('Save');
                $("#delete-header").text('Cancel');
            }
            ...
            $('#editable-sample_new').click(function (e) {
                e.preventDefault();
                var aiNew = oTable.fnAddData(['<input type="checkbox" id="select-all" value="">', '', '', '','','','','','','',
            ...
            $('#editable-sample a.delete').live('click', function (e) {
                e.preventDefault();
                $(this).parents('tr').toggleClass('deleting');
